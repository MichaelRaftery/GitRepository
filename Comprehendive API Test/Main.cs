/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘Comprehendive API Test.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.IfElse7 = new HP.ST.Fwk.RunTimeFWK.CompositeActivities.IfElse<IfElse7Input>(_context,"IfElse7");
            _flow.IfElseBranch8 = new HP.ST.Fwk.RunTimeFWK.CompositeActivities.IfElseBranch(_context,"IfElseBranch8");
            _flow.IfElseBranch9 = new HP.ST.Fwk.RunTimeFWK.CompositeActivities.IfElseBranch(_context,"IfElseBranch9");
            ...
            string xmlDataFetchActivity13Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>8ea6332a-05eb-4ed0-855c-d853c2fbb84b</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>GetFlights_Input_1!MainDetails</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>True</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value>GetFlights_Input_1</Value></QueryParameter><QueryParameter><Name>FilePath</Name><Value>" + _context.ResourceManager.GetValue("{GetFlights_Input_1!MainDetails.TablePath}") + "</Value></QueryParameter><QueryParameter><Name>SheetName</Name><Value>MainDetails$</Value></QueryParameter><QueryParameter><Name>ContainsHeadersRow</Name><Value>True</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.dataSourceNameToDataSource.Add("GetFlights_Input_1!MainDetails", _flow.DataFetchActivity13);
            ...
            _flow.Loop2.ConditionAsString = @"For each item in {DataSource.GetFlights_Input_1!MainDetails}";
            ...
            VTDPropertyInfoBase pi46 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter24 = new VTDObjectGetter(pi46);
            VTDPropertyInfoBase pi47 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter23 = new VTDObjectSetter(pi47);
            binding_setter23 = new StringFormaterDecorator(binding_setter23,"{Step.DataFetchActivity13.OutTable}");
            bind_dir23 = new BindDirection(_flow.DataFetchActivity13,binding_getter24,binding_setter23,BindTargetType.ToInProperty);
            _flow.DataExporterActivity15.InDirections.Add(bind_dir23);
            ...
            VTDPropertyInfoBase pi49 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter24 = new VTDObjectSetter(pi49);
            binding_setter24 = new StringFormaterDecorator(binding_setter24,"{Step.DataFetchActivity13.OutTable}");
            bind_dir24 = new BindDirection(_flow.DataFetchActivity13,binding_getter25,binding_setter24,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity14.InDirections.Add(bind_dir24);
            this.Activities.Add (_flow.DataDisconnectActivity14);
            this.DataCursorActivity17.Comment = @"";
            this.DataCursorActivity17.IconPath = @"";
            VTDPropertyInfoBase pi50 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter26 = new VTDObjectGetter(pi50);
            VTDPropertyInfoBase pi51 = new VTDPropertyInfoBase("InTable");
            VTDBaseSetter binding_setter25 = new VTDObjectSetter(pi51);
            binding_setter25 = new StringFormaterDecorator(binding_setter25,"{Step.DataFetchActivity13.OutTable}");
            bind_dir25 = new BindDirection(_flow.DataFetchActivity13,binding_getter26,binding_setter25,BindTargetType.ToInProperty);
            this.DataCursorActivity17.InDirections.Add(bind_dir25);
            ...
            _flow.Sequence12.Activities.Add (_flow.ReportMessageActivity6);
            _flow.Sequence12.Activities.Add (_flow.IfElse7);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.GetFlights_Input_1!MainDetails.DepartureCity}</DepartureCity><ArrivalCity>{DataSource.GetFlights_Input_1!MainDetails.ArrivalCity}</ArrivalCity><FlightDate>{DataSource.GetFlights_Input_1!MainDetails.FlightDate}</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi52 = new VTDPropertyInfoBase("FlightDate");
            ...
            VTDBaseSetter binding_setter26 = new VTDXPathSetter(pi53,XmlTypeCode.DateTime);
            bind_dir26 = new BindDirection(this.DataCursorActivity17,binding_getter27,binding_setter26,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir26);
            VTDPropertyInfoBase pi54 = new VTDPropertyInfoBase("DepartureCity");
            VTDBaseGetter binding_getter28 = new VTDObjectGetter(pi54);
            VTDPropertyInfoBase pi55 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter27 = new VTDXPathSetter(pi55,XmlTypeCode.String);
            binding_setter27 = new StringFormaterDecorator(binding_setter27,"{DataSource.GetFlights_Input_1!MainDetails.DepartureCity}");
            bind_dir27 = new BindDirection(this.DataCursorActivity17,binding_getter28,binding_setter27,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir27);
            VTDPropertyInfoBase pi56 = new VTDPropertyInfoBase("ArrivalCity");
            VTDBaseGetter binding_getter29 = new VTDObjectGetter(pi56);
            VTDPropertyInfoBase pi57 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter28 = new VTDXPathSetter(pi57,XmlTypeCode.String);
            binding_setter28 = new StringFormaterDecorator(binding_setter28,"{DataSource.GetFlights_Input_1!MainDetails.ArrivalCity}");
            bind_dir28 = new BindDirection(this.DataCursorActivity17,binding_getter29,binding_setter28,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir28);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>First</Class><CustomerName>Mike Raftery</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity4.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>2</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi58 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseGetter binding_getter30 = new VTDXPathGetter(pi58,XmlTypeCode.Int);
            binding_getter30 = new XPathGetterDecorator(binding_getter30,"{Array0}",1);
            VTDPropertyInfoBase pi59 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseSetter binding_setter29 = new VTDXPathSetter(pi59,XmlTypeCode.Int);
            bind_dir29 = new BindDirection(_flow.StServiceCallActivity4,binding_getter30,binding_setter29,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir29);
            VTDPropertyInfoBase pi60 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='FlightDate'][1]");
            VTDBaseGetter binding_getter31 = new VTDXPathGetter(pi60,XmlTypeCode.DateTime);
            VTDPropertyInfoBase pi61 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='DepartureDate'][1]");
            VTDBaseSetter binding_setter30 = new VTDXPathSetter(pi61,XmlTypeCode.DateTime);
            bind_dir30 = new BindDirection(_flow.StServiceCallActivity4,binding_getter31,binding_setter30,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir30);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><CreateFlightOrderResponse xmlns=""HP.SOAQ.SampleApp""><CreateFlightOrderResult><OrderNumber /><TotalPrice>500</TotalPrice></CreateFlightOrderResult></CreateFlightOrderResponse></Body></Envelope>");
...
@"<OutputAttachments />");
            ...
            _flow.ReportMessageActivity6.Message = @"Flight order number {Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}  for ${Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.TotalPrice} has been created";
            ...
            _flow.ReportMessageActivity6.Name = @"Order creation message";
            VTDPropertyInfoBase pi62 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='OrderNumber'][1]");
            VTDBaseGetter binding_getter32 = new VTDXPathGetter(pi62,XmlTypeCode.Int);
            VTDPropertyInfoBase pi63 = new VTDPropertyInfoBase("Message");
            VTDBaseSetter binding_setter31 = new VTDObjectSetter(pi63);
            binding_setter31 = new StringFormaterDecorator(binding_setter31,"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}");
            bind_dir31 = new BindDirection(_flow.StServiceCallActivity5,binding_getter32,binding_setter31,BindTargetType.ToInProperty);
            _flow.ReportMessageActivity6.InDirections.Add(bind_dir31);
            VTDPropertyInfoBase pi64 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='TotalPrice'][1]");
            VTDBaseGetter binding_getter33 = new VTDXPathGetter(pi64,XmlTypeCode.Float);
            VTDPropertyInfoBase pi65 = new VTDPropertyInfoBase("Message");
            VTDBaseSetter binding_setter32 = new VTDObjectSetter(pi65);
            binding_setter32 = new StringFormaterDecorator(binding_setter32,"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.TotalPrice}");
            bind_dir32 = new BindDirection(_flow.StServiceCallActivity5,binding_getter33,binding_setter32,BindTargetType.ToInProperty);
            _flow.ReportMessageActivity6.InDirections.Add(bind_dir32);
            _flow.IfElse7.ConditionAsString = @"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.TotalPrice} LessThan 300";
            _flow.IfElse7.Comment = @"";
            _flow.IfElse7.IconPath = @"AddIns\ServiceTest\BasicActivities\toolbox_if_else.png";
            _flow.IfElse7.Name = @"Check Ticket Price";
            _flow.IfElse7.Activities.Add (_flow.IfElseBranch8);
            _flow.IfElse7.Activities.Add (_flow.IfElseBranch9);
            _flow.IfElseBranch8.Condition += delegate(object sender,EventArgs e)
            {
            	try
            	{
            VTDPropertyInfoBase pi66 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='TotalPrice'][1]");
            VTDBaseGetter binding_getter34 = new VTDXPathGetter(pi66,XmlTypeCode.Float);
            		System.Single expr00 = (System.Single)HP.ST.Fwk.RunTimeFWK.Utilities.Utils.ConvertValue(_flow.StServiceCallActivity5.GetParam(binding_getter34),typeof(System.Single));
            		var result0 = expr00;
            		System.Single result1 = (System.Single)(300);
            ...
            _flow.IfElseBranch8.Name = @"Yes";
            _flow.IfElseBranch8.Activities.Add (_flow.ReportMessageActivity10);
            _flow.IfElseBranch9.Condition += delegate(object sender,EventArgs e)
            {
            return true;
            };
            _flow.IfElseBranch9.Comment = @"";
            _flow.IfElseBranch9.IconPath = @"";
            _flow.IfElseBranch9.Name = @"No";
            _flow.IfElseBranch9.Activities.Add (_flow.ReportMessageActivity11);
            _flow.ReportMessageActivity10.Status = @"Pass";
            _flow.ReportMessageActivity10.Message = @"Orfder number {Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber} for ${Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.TotalPrice} is within guidelines and requires no additional approval.";
            ...
            _flow.ReportMessageActivity10.Name = @"Price within guidelines";
            VTDPropertyInfoBase pi67 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='OrderNumber'][1]");
            VTDBaseGetter binding_getter35 = new VTDXPathGetter(pi67,XmlTypeCode.Int);
            VTDPropertyInfoBase pi68 = new VTDPropertyInfoBase("Message");
            VTDBaseSetter binding_setter33 = new VTDObjectSetter(pi68);
            binding_setter33 = new StringFormaterDecorator(binding_setter33,"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}");
            bind_dir33 = new BindDirection(_flow.StServiceCallActivity5,binding_getter35,binding_setter33,BindTargetType.ToInProperty);
            _flow.ReportMessageActivity10.InDirections.Add(bind_dir33);
            VTDPropertyInfoBase pi69 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='TotalPrice'][1]");
            VTDBaseGetter binding_getter36 = new VTDXPathGetter(pi69,XmlTypeCode.Float);
            VTDPropertyInfoBase pi70 = new VTDPropertyInfoBase("Message");
            VTDBaseSetter binding_setter34 = new VTDObjectSetter(pi70);
            binding_setter34 = new StringFormaterDecorator(binding_setter34,"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.TotalPrice}");
            bind_dir34 = new BindDirection(_flow.StServiceCallActivity5,binding_getter36,binding_setter34,BindTargetType.ToInProperty);
            _flow.ReportMessageActivity10.InDirections.Add(bind_dir34);
            _flow.ReportMessageActivity11.Status = @"Fail";
            _flow.ReportMessageActivity11.Message = @"Orfder number {Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber} for ${Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.TotalPrice} is ABOVE guidelines and requires additional approval.";
            ...
            _flow.ReportMessageActivity11.Name = @"Price exceeds guidelines";
            VTDPropertyInfoBase pi71 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='OrderNumber'][1]");
            VTDBaseGetter binding_getter37 = new VTDXPathGetter(pi71,XmlTypeCode.Int);
            VTDPropertyInfoBase pi72 = new VTDPropertyInfoBase("Message");
            VTDBaseSetter binding_setter35 = new VTDObjectSetter(pi72);
            binding_setter35 = new StringFormaterDecorator(binding_setter35,"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}");
            bind_dir35 = new BindDirection(_flow.StServiceCallActivity5,binding_getter37,binding_setter35,BindTargetType.ToInProperty);
            _flow.ReportMessageActivity11.InDirections.Add(bind_dir35);
            VTDPropertyInfoBase pi73 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='TotalPrice'][1]");
            VTDBaseGetter binding_getter38 = new VTDXPathGetter(pi73,XmlTypeCode.Float);
            VTDPropertyInfoBase pi74 = new VTDPropertyInfoBase("Message");
            VTDBaseSetter binding_setter36 = new VTDObjectSetter(pi74);
            binding_setter36 = new StringFormaterDecorator(binding_setter36,"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.TotalPrice}");
            bind_dir36 = new BindDirection(_flow.StServiceCallActivity5,binding_getter38,binding_setter36,BindTargetType.ToInProperty);
            _flow.ReportMessageActivity11.InDirections.Add(bind_dir36);
