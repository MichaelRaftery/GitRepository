/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘Demo3-Complete.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity7Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>caabd040-4148-4c87-9a8b-fa8341610567</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>GetFlights_Input_1!MainDetails</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>True</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value>GetFlights_Input_1</Value></QueryParameter><QueryParameter><Name>FilePath</Name><Value>" + _context.ResourceManager.GetValue("{GetFlights_Input_1!MainDetails.TablePath}") + "</Value></QueryParameter><QueryParameter><Name>SheetName</Name><Value>MainDetails$</Value></QueryParameter><QueryParameter><Name>ContainsHeadersRow</Name><Value>True</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.dataSourceNameToDataSource.Add("GetFlights_Input_1!MainDetails", _flow.DataFetchActivity7);
            ...
            _flow.DataExporterActivity9.InDirections.Add(bind_dir17);
            ...
            _flow.DataDisconnectActivity8.InDirections.Add(bind_dir18);
            ...
            this.DataCursorActivity11.InDirections.Add(bind_dir19);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.GetFlights_Input_1!MainDetails.DepartureCity}</DepartureCity><ArrivalCity>{DataSource.GetFlights_Input_1!MainDetails.ArrivalCity}</ArrivalCity><FlightDate>{DataSource.GetFlights_Input_1!MainDetails.FlightDate}</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi39 = new VTDPropertyInfoBase("FlightDate");
            ...
            bind_dir20 = new BindDirection(this.DataCursorActivity11,binding_getter20,binding_setter20,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir20);
            VTDPropertyInfoBase pi41 = new VTDPropertyInfoBase("DepartureCity");
            ...
            binding_setter21 = new StringFormaterDecorator(binding_setter21,"{DataSource.GetFlights_Input_1!MainDetails.DepartureCity}");
            bind_dir21 = new BindDirection(this.DataCursorActivity11,binding_getter21,binding_setter21,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir21);
            VTDPropertyInfoBase pi43 = new VTDPropertyInfoBase("ArrivalCity");
            ...
            binding_setter22 = new StringFormaterDecorator(binding_setter22,"{DataSource.GetFlights_Input_1!MainDetails.ArrivalCity}");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>First</Class><CustomerName>Mike Raftery</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity4.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>2</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi45 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='FlightNumber'][1]");
            ...
            VTDPropertyInfoBase pi47 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='FlightDate'][1]");
            VTDBaseGetter binding_getter24 = new VTDXPathGetter(pi47,XmlTypeCode.DateTime);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><CreateFlightOrderResponse xmlns=""HP.SOAQ.SampleApp""><CreateFlightOrderResult><TotalPrice>250</TotalPrice></CreateFlightOrderResult></CreateFlightOrderResponse></Body></Envelope>");
